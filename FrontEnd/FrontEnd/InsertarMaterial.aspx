<%@ Page Title="" Language="C#" MasterPageFile="~/AdminBiblio.Master" AutoEventWireup="true" CodeBehind="InsertarMaterial.aspx.cs" Inherits="FrontEnd.InsertarMaterial" MaintainScrollPositionOnPostBack="true" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    Inserte los detalles del nuevo material
    </div>
    ...
    <div class="form-group">
        ...
        <div class="d-flex justify-content-center gap-3 align-items-center">
            ...
            Text="Insertar Material" OnClick="btnInsertar_Click" />        </div>
